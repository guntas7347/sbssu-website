    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r from-orange-600 to-green-600 py-16 px-4">
        <div className="max-w-7xl mx-auto text-center text-white">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Eligibility Criteria</h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Admissions to all programs at SBSSU are based on merit. Candidates must meet the minimum eligibility criteria and qualify in the entrance examination (where applicable). Reservation policy as per Punjab Government norms is followed.
            </p>
          </div>

          <div className="space-y-6 mb-12">
            {eligibilityCriteria.map((criteria, index) => (
              <div key={index} className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:shadow-xl hover:border-orange-600 transition">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div className="bg-white rounded-xl shadow-lg p-8">
              <h3 className="text-xl font-bold text-gray-800 mb-6">Reservation Policy</h3>
              <div className="space-y-3">
                {reservationPolicy.map((policy, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-orange-50 rounded-lg">
                    <span className="font-semibold text-gray-800">{policy.category}</span>
                    <span className="text-orange-600 font-bold">{policy.percentage}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              <h3 className="text-xl font-bold text-gray-800 mb-6">Additional Requirements</h3>
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-2 text-gray-700">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span>Migration certificate (for other university students)</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
          ...
          <div className="bg-blue-50 rounded-xl p-6 border-l-4 border-blue-600 flex gap-4">
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm text-gray-700">
                <li>• Eligibility criteria subject to change as per university/government norms</li>
                <li>• Candidates must verify their eligibility before applying</li>
                <li>• Admission is provisional until verification of original documents</li>
                <li>• Reserved category candidates must produce valid certificates</li>
                <li>• For detailed information, refer to the admission brochure</li>
              </ul>
            </div>
          </div>
        </div>
