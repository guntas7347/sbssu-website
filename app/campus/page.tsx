...
import { Building2, ShoppingBag, Map, Camera, Hotel, Bus, Utensils, Stethoscope } from 'lucide-react';
...
export default function CampusPage() {
  const campusSections = [
    {
      title: 'Hostels',
      description: 'Comfortable accommodation for boys and girls with modern facilities',
      icon: Hotel,
      href: '/campus/hostels',
      color: 'orange'
    },
    {
      ...
      description: 'On-campus shopping facilities including stationary, photocopying, and more',
      icon: ShoppingBag,
    ...
    },
    {
      ...
      description: 'Interactive campus map showing all buildings and facilities',
      icon: Map,
      href: '/campus/map',
      color: 'green'
    },
      ...
      <div className="bg-gradient-to-r from-orange-600 to-green-600 py-16 px-4">
        <div className="max-w-7xl mx-auto text-center text-white">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto">
            Explore our vibrant campus spread across 98 acres with world-class facilities
          </p>
        </div>
      </div>
