              ...
              return (
                <button
                  ...
                  className={`p-4 rounded-xl transition ${
                    isActive
                      ? "bg-linear-to-r from-orange-600 to-green-600 text-white shadow-lg"
                ...
                >
                  <div className="p-6">
                    ...
                    <a
                      href={item.file_url}
                      download
                      className="w-full bg-linear-to-r from-orange-600 to-green-600 text-white px-4 py-3 rounded-lg font-semibold hover:from-orange-700 hover:to-green-700 transition flex items-center justify-center gap-2"
                    >
