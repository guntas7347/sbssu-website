...
export default function PlacementPage() {
  ...
  return (
    <div>
      <section className="relative h-[400px] bg-linear-to-r from-orange-600 to-green-600 text-white">
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-orange-50 to-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-linear-to-r from-orange-600 to-green-600 mx-auto mb-12"></div>
          </div>
