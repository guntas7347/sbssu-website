  ...
  return (
    <div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {coordinators.map((member) => (
                  ...
                  >
                    <div className="bg-linear-to-r from-orange-600 to-green-600 h-32"></div>
          ...
          {faculty.length > 0 && (
            <div>
              <div className="text-center mb-12">
                ...
                <div className="w-24 h-1 bg-linear-to-r from-green-600 to-orange-600 mx-auto"></div>
              </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="bg-linear-to-r from-orange-600 to-green-600 rounded-2xl p-8 md:p-12 text-white">
