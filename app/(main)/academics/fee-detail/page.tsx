...
export default function FeeDetailPage() {
  ...
  const scholarships = [
    ...
    },
    {
      ...
      eligibility: "Economically Weaker Section",
      amount: "As per government norms",
    },
    {
      name: "Sports Quota",
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {scholarships.map((scholarship, index) => (
                <div
                  key={index}
                  className="border-2 border-gray-200 rounded-lg p-6 hover:border-orange-600 transition"
                >
          ...
          <div className="bg-yellow-50 rounded-xl p-6 border-l-4 border-yellow-600 flex gap-4">
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm text-gray-700">
                <li>
                  • Hostel and mess fees are optional (for hostel residents
                  only)
                </li>
                <li>
                  • Fee structure subject to revision by university authorities
                </li>
                <li>
                  • Caution money of ₹5,000 refundable at the end of program
                </li>
                <li>• Library security deposit of ₹2,000 (refundable)</li>
                <li>
                  • For detailed fee breakup, download the official fee
                  structure document
                </li>
              </ul>
              <a
                href="/downloads/fee-structure-2024-25.pdf"
                className="inline-flex items-center gap-2 mt-4 px-6 py-3 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition font-semibold"
              >
