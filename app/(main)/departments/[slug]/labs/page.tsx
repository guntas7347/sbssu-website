  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([depts, labsData]) => {
        ...
        setDepartment(dept);
        if (dept) {
          const deptLabs = labsData.filter(
            (l: any) => l.department_id === dept.id
          );
          setLabs(deptLabs);
        }
      })
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              providing hands-on learning experience to students. Our labs are
              regularly updated with the latest equipment and software to ensure
              students get exposure to current industry standards.
            </p>
          </div>
