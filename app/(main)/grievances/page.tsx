...
export default function GrievancesPage() {
  ...
  return (
    <div>
      <section className="bg-linear-to-r from-orange-600 to-green-600 text-white py-16 px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-16">
            {grievanceProcess.map((step, index) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 bg-linear-to-r from-orange-100 to-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      type="submit"
                      className="w-full bg-linear-to-r from-orange-600 to-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-orange-700 hover:to-green-700 transition flex items-center justify-center gap-2"
                    >
