        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            {societies.map((society) => (
              <div key={society.id} className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:shadow-xl transition">
                <h3 className="text-2xl font-bold text-gray-800 mb-4">{society.name}</h3>
                <p className="text-gray-600 mb-6">{society.description}</p>
                <div className="mb-4">
                  <h4 className="font-semibold text-gray-800 mb-2">Faculty Coordinator</h4>
                  <p className="text-gray-700">{society.coordinator}</p>
                </div>
                <div className="mb-4">
                  <h4 className="font-semibold text-gray-800 mb-2">Student Coordinators</h4>
                  <p className="text-gray-700">{society.student_coordinators}</p>
                </div>
                <div>
