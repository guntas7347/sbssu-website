      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
              ...
              <div className="md:w-1/3 bg-gradient-to-br from-orange-600 to-green-600 p-8 text-white">
                ...
                <div className="text-center">
                  ...
                  <div className="space-y-3 text-sm">
                    <a href={`mailto:${hodData.email}`} className="flex items-center gap-2 justify-center hover:text-orange-200">
                      <Mail className="w-4 h-4" />
                      <span>{hodData.email}</span>
                    </a>
                    <a href={`tel:${hodData.phone}`} className="flex items-center gap-2 justify-center hover:text-orange-200">
              ...
              <div className="md:w-2/3 p-8">
                ...
                {hodData.qualifications && (
                  <div className="mt-8 pt-8 border-t border-gray-200">
                    <h4 className="text-xl font-bold text-gray-800 mb-4">Qualifications</h4>
                    <ul className="space-y-2">
                      {hodData.qualifications.split(',').map((qual: string, idx: number) => (
                ...
                {hodData.research_interests && (
                  <div className="mt-6">
                    <h4 className="text-xl font-bold text-gray-800 mb-4">Research Interests</h4>
                    <div className="flex flex-wrap gap-2">
                      {hodData.research_interests.split(',').map((interest: string, idx: number) => (
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h3 className="text-2xl font-bold text-gray-800 mb-6">About the Department</h3>
            <p className="text-gray-600 leading-relaxed mb-6">{department.description}</p>
