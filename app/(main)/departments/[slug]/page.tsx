  ...
  const sections = [
    {
      ...
      icon: GraduationCap,
      href: `/departments/${slug}/head`,
      color: "orange",
    },
    {
      title: "Faculty Profiles",
      icon: Users,
      href: `/departments/${slug}/faculty`,
      color: "green",
    },
    {
      title: "Board of Studies",
      icon: FileText,
      href: `/departments/${slug}/bos`,
      color: "orange",
    },
    {
      title: "Course Outcomes",
      icon: Target,
      href: `/departments/${slug}/outcomes`,
      color: "green",
    },
    {
      title: "Laboratories",
      icon: FlaskConical,
      href: `/departments/${slug}/labs`,
      color: "orange",
    },
    {
    ...
    },
    {
      ...
      icon: UsersRound,
      href: `/departments/${slug}/society`,
      color: "orange",
    },
    {
      title: "Student Survey Form",
      icon: ClipboardList,
      href: `/departments/${slug}/survey`,
      color: "green",
    },
    {
      title: "Time Table",
      icon: Calendar,
      href: `/departments/${slug}/timetable`,
      color: "orange",
    },
  ];
      ...
      <div className="bg-gradient-to-r from-orange-600 to-green-600 py-16 px-4">
        <div className="max-w-7xl mx-auto text-center text-white">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto">
            Established in {department.established_year} |{" "}
            {department.building_location}
          </p>
        </div>
      </div>
