...
export default function CourseOutcomesPage() {
  ...
  const pos = [
    ...
    },
    {
      ...
      description:
        "Identify, formulate, research and analyze complex engineering problems using first principles",
    },
    {
      code: "PO3",
      title: "Design/Development",
      description:
        "Design solutions for complex problems and design systems that meet specified needs",
    },
    {
      code: "PO4",
      title: "Investigation",
      description:
        "Conduct investigations of complex problems using research-based knowledge and methods",
    },
    {
      code: "PO5",
      title: "Modern Tools",
      description:
        "Create, select and apply appropriate techniques and modern engineering tools",
    },
    {
      code: "PO6",
      title: "Ethics",
  ...
  const psos = [
    {
      code: "PSO1",
      description:
        "Ability to apply domain knowledge to develop software solutions for real-world problems",
    },
    {
      code: "PSO2",
      description:
        "Ability to work with modern tools and technologies in the field of specialization",
    },
    {
      code: "PSO3",
      description:
        "Ability to pursue higher studies and research in the domain",
    },
  ];
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-6 bg-orange-50 rounded-lg border-l-4 border-orange-600">
                ...
                <p className="text-sm text-gray-700">
                  Excel in professional careers through technical expertise and
                  innovation
                </p>
              </div>
              <div className="p-6 bg-green-50 rounded-lg border-l-4 border-green-600">
                ...
                <p className="text-sm text-gray-700">
                  Pursue higher studies and research in their field of interest
                </p>
              </div>
              <div className="p-6 bg-orange-50 rounded-lg border-l-4 border-orange-600">
                <h3 className="font-bold text-gray-800 mb-2">PEO 3</h3>
                <p className="text-sm text-gray-700">
                  Work ethically and contribute to society and nation building
                </p>
              </div>
            </div>
          </div>
